            ...
            if n_offset == 0:
                ...
                btn.append(
                    [
                        ...
                        InlineKeyboardButton("PAGE ➪", callback_data=f"next_{req}_{key}_{n_offset}")
                    ],
                )
        else:
...
async def auto_filter(client, msg, spoll=False):
    ...
    # else:
    if settings["button"]:
        cap = <img src="https://telegra.ph/file/5e2d4418525832bc9a1b9.jpg" alt="0001"> f"<b>Tʜᴇ Rᴇꜱᴜʟᴛꜱ Fᴏʀ ☞ {search}\n\nRᴇǫᴜᴇsᴛᴇᴅ Bʏ ☞ {message.from_user.mention}\n\nʀᴇsᴜʟᴛ sʜᴏᴡ ɪɴ ☞ {remaining_seconds} sᴇᴄᴏɴᴅs\n\nᴘᴏᴡᴇʀᴇᴅ ʙʏ ☞ : {message.chat.title} \n\n⚠️ ᴀꜰᴛᴇʀ 5 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ 🗑️\n\n</b>"
    else:
